...
def load_data():
    imgs = {'tiger': [], 'kittycat': []}
    for k in imgs.keys():
        dir = 'D:\Python Program/Transferlearning/data/' + k
...
class Vgg16:
    ...
    def save(self, path='D:\Python Program/Transferlearning/model/transfer_learn'):
        saver = tf.train.Saver()
...
def train():
    ...
    xs = np.concatenate(tigers_x + cats_x, axis=0)  # axis=0)
    ys = np.concatenate((tigers_y, cats_y), axis=0)

    vgg = Vgg16(vgg16_npy_path='D:\Python Program/Transferlearning/vgg16.npy')
    print('Net built')
    for i in range(1000):
    ...
    vgg.save('D:\Python Program/Transferlearning/model/transfer_learn')      # save learned fc layers


def eval():
    vgg = Vgg16(vgg16_npy_path='D:\Python Program/Transferlearning/vgg16.npy',
                restore_from='D:\Python Program/Transferlearning/model/transfer_learn')
    vgg.predict(
        ['D:\Python Program/Transferlearning/data/kittycat/0.jpg', 'D:\Python Program/Transferlearning/data/tiger/_1768316_tiger6.jpg'])
